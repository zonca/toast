...
#
# $> ./cmake/platforms/cori-knl_intel_mkl.sh \
...
ROOT=${PWD}
DIR=${PWD}/build-toast/cori-knl-intel-mkl/release
OPTS="$@"
...
cmake -DCMAKE_BUILD_TYPE=Release -DUSE_OPENMP=ON \
    ...
    -DUSE_MATH=ON \
    -DCMAKE_TOOLCHAIN_FILE=${ROOT}/Toolchains/Cori-KNL.cmake \ # to be written later
