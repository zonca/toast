  ...
  if (interrogate AND ((NOT MPI_${lang}_INCLUDE_PATH) OR (NOT MPI_${lang}_LIBRARIES)))
    if (MPI_${lang}_COMPILER)
      ...
      if (MPI_COMPILE_CMDLINE OR MPI_LINK_CMDLINE)
        ...
        string(REGEX MATCHALL "(^| )-[(Df|p)]([^\" ]+|\"[^\"]+\")" MPI_ALL_COMPILE_FLAGS "${MPI_COMPILE_CMDLINE}")
        ...
        string(REGEX MATCHALL "(^| )-(Wl,|p)([^\" ]+|\"[^\"]+\")" MPI_ALL_LINK_FLAGS "${MPI_LINK_CMDLINE}")
...
find_program(MPIEXEC
  ...
  HINTS ${MPI_HOME} $ENV{MPI_HOME} ${MPI_ROOT} $ENV{MPI_ROOT}
